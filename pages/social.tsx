                    ...
                    <div className="mt-8 grid gap-5">
                        {
                            groups.map(group => (
                                <div className="rounded mx-5 border-accent border  relative">
                                    <span
                                        className="absolute top-0 left-0 transform -translate-y-1/2 text-accent bg-white font-bold border-2 text-accent border-accent px-2 rounded">{group.name}</span>
                                    {group.balance !== null && (
                                        <span
                                            className={[
                                        ...
                                        {group.balance > 0 && '+'}{group.balance} EUR
                                    </span>
                                    )}
