          ...
          <div className="mt-8 grid gap-5 animate-jump">
            {groups.map((group) => (
              <div className="rounded mx-5 border-accent border  relative">
                <span className="absolute top-0 left-0 transform -translate-y-1/2  bg-white font-bold border-2 text-accent border-accent px-1 rounded">
                  {group.name}
                </span>
                {group.balance !== null && (
                  <span
              ...
              <table className="mt-5 align-middle w-full">
                {new Array(2).fill(
                  <tr>
                    ...
                    <td className="text-right text-sm">20/300 EUR</td>
                  </tr>
                )}
              </table>
