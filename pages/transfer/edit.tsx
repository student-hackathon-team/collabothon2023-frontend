    ...
    return (
        <div className="w-screen h-screen bg-black">
            ...
            <div className="fixed bottom-0 left-0 w-full">
                <div className="flex justify-end">
                    {
                        step === 'editing-video' && (
                            <button
                                ...
                                className="border-t border-t-2 border-primary bg-[#3A71F9] text-white font-bold px-6 py-3 block w-full flex items-center justify-center font-bold">
                ...
                {
                    step === 'sending' && (
                        <div className="rounded-t-xl bg-white px-5 pb-10 pt-7">
                            <h3 className="font-bold text-xl text-center mb-5">Enter recipient info</h3>

                            <div className="">
                                <div className="flex justify-center">
                                    <input type="text" className="border-b-2 border-primary text-primary w-10ch text-center inline-block outline-none text-2xl" placeholder="@jane38"/>
                                </div>
                                <span className="block text-sm text-center text-gray-600 mt-2">username</span>
                            </div>
                            <div className="mt-5">
                                <div className="flex justify-center">
                                    <input type="text" className="border-b-2 border-primary text-primary w-10ch text-center inline-block outline-none text-2xl" placeholder="25"/>
                                </div>
